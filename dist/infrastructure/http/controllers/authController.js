...
exports.facebookLoginController = facebookLoginController;
...
const facebookLogin_1 = require("../../../core/usecases/auth/facebookLogin");
...
async function facebookLoginController(req, res) {
    try {
        ...
        if (!token)
            return res.status(400).json({ message: "Token requis" });
        const result = await (0, facebookLogin_1.facebookLogin)({ token, phone });
        return res.json({
