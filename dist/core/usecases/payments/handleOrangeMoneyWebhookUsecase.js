...
exports.handleOrangeMoneyWebhookUsecase = handleOrangeMoneyWebhookUsecase;
...
async function handleOrangeMoneyWebhookUsecase(payload) {
    ...
    if (payload.status === "SUCCESS") {
        ...
        const fees = await (0, calculateFeesForOrderUsecase_1.calculateFeesForOrderUsecase)(payment.orderId, "ORANGE_MONEY");
