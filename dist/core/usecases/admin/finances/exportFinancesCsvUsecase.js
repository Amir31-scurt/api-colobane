...
exports.exportFinancesCsvUsecase = exportFinancesCsvUsecase;
const prismaClient_1 = require("../../../../infrastructure/prisma/prismaClient");
async function exportFinancesCsvUsecase(type) {
    switch (type) {
        case "sales":
            return exportSales();
        case "payments":
...
async function exportPayments() {
    const payments = await prismaClient_1.prisma.payment.findMany({
        include: {
            order: {
                include: {
                    user: true
